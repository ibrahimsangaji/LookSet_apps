                ...
                <div class="container">
                    ...
                    <div class="mt-5 py-5 d-flex justify-content-between">
                        ...
                        <div class="col-2">
                            ...
                            <p class="font-weight-bold text-center">
                                @if ($asset->outbound)
                                    {{ $asset->outbound->createdUser->name }}
                                @endif
                            </p>
                        </div>
                        <div class="col-2">
                            ...
                            <p class="font-weight-bold text-center">
                                @if ($asset->outbound)
                                    @if ($asset->outbound->approvalUser === null)
                                        PIC
                                    @else
                                        {{ $asset->outbound->approvalUser->name }}
                                    @endif
                                @endif
                            </p>
                        </div>
